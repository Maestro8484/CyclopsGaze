...
- **Dual-eye** (optional): both GC9A01A displays tracking together.
- **Detached camera module** (optional): the SEN0626 lens/ribbon separated from the Gravity board.

Keep files reasonably sized (long-edge ~1600 px for photos) so the repo stays lightweight. A short
tracking clip as a GIF or MP4 is welcome too.
